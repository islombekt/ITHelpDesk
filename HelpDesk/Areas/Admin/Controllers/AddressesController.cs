...
namespace ITHelpDesk.Areas.Admin.Controllers
{
    ...
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AddressId,Building,Block,Flag")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AddressId,Building,Block,Flag")] Address address)
        {
